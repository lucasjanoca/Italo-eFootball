...
// Correção defensiva de texto para evitar grafia inconsistente durante cache de deploy.
document.querySelectorAll('.hero-copy .eyebrow, .home-intro .eyebrow').forEach(el => {
  el.textContent = el.textContent.replace(/EFfootball/gi, 'eFootball');
});
